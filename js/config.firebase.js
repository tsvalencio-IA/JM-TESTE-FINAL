...
window.JM_CONFIG = {
  ...
  mobileGps: {
    // Fallback operacional seguro. A configuração salva pelo Superadmin continua
    // tendo prioridade e pode desativar explicitamente este módulo.
    enabled: true,
    backend: "realtime_database",
    databaseURL: "https://frvalencio-default-rtdb.firebaseio.com",
    pollingMs: 10000,
    minIntervalMs: 20000,
